---
title: "Intro to R part 1 - Module 1"
...
# as long as we specify the aguments we can also enter them in a different order
seq(to = 10,
    from = 1,
    by = 1)
...
Click [here](day1_2.R) to download the script for this today's lab! I recommend right-clicking (or command-clicking for Macs) on the link and selecting the "Save As" option from the context menu. Save the script to the 'scripts' folder in the 'R Crash Course' folder we just created, which will serve as your **working directory** for this course. 
