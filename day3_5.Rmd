---
title: "Intro to R part 3 -  Module 5"
author: "Data Visualization in Base R"
...
1. Click [here](day3_5.R) to download the script! Save the script to the scripts folder (R Project folder).
