...
We can also reorder the columns in our data set using `relocate()`. In the turtles_tidy data if we want 'weight' to come before 'c_length' we can reorder the columns as follows
```{r}
# ordering data
